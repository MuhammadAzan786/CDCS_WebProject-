          ...
          <div className=" ">
            ...
            <div className="p-2 flex flex-col items-center relative">
              <h1
                ...
                data-aos="fade-up"
              >
                <span className="text-[#03A651]">Corporate Debt</span> Services
              </h1>
              <img
                src={Rectangle}
                alt=""
              ...
              />
              <div
                className="max-w-[1110px] max-h-[240px] flex items-center justify-center flex-col  px-5 h-[180px]  rounded-[16px] bg-[#F9FDFF] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.12)] xs:top-[14rem] absolute top-48 sm:top-[18rem] md:top-[50.417vw] w-[83.333vw] lg:h-[240px] xl:top-[700.796px]"
                data-aos="fade-up"
              >
                <p className="max-w-[1095px] max-h-[149.14px]  text-[#210F03] text-center font-Poppins xl:text-[30px] lg:text-2xl font-light  xl:leading-[45px] text-sm xs:text-base">
                  <span className="text-[#03A651] font-bold">CDCS </span>
                  is offering secure, compliant debt collection, skip tracing,
                  asset tracing, and profile verification services for banks,
                  financial institutions, and embassies in the UAE, Qatar, and
                  globally.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-[1440px] mx-auto  lg:px-6  xl:px-12 max-md:p-2  md:p-5 ">
          <div className=" ">
            <div className="p-2 mt-44 md:mt-32 flex flex-col md:flex-row md:gap-20 md:items-start items-center  lg:gap-32 xl:gap-40">
              {/* images */}
              <div
                className="flex flex-row md:flex-col relative  max-md:gap-3 md:mt-20 lg:mt-32 xl:mt-40"
                data-aos="fade-right"
              >
                <div className="max-w-[439.052px] max-h-[367.6px]  rounded-[21px_21px_11px_11px] bg-[rgba(217,217,217,0.39)] w-[50%] h-[50%] md:w-[100%] md:h-[100%] ">
                  <img
                    src={Rectangleuper}
                    alt=""
                    className=" shadow-2xl rounded-[21px_21px_11px_11px]"
                  />
                </div>
                <div className="max-w-[439.052px] max-h-[367.6px]  rounded-[21px_21px_11px_11px] bg-[rgba(217,217,217,0.39)] w-[50%] h-[50%] md:w-[90%] lg:w-[100%]">
                  <img
                    src={Rectangledown}
                    alt=""
                    className="opacity-90 md:absolute md:left-[8.542vw] md:top-[16.628vw] 2xl:left-[124.03px] 2xl:top-[241.439px] shadow-2xl   md:w-[90%] lg:w-[100%]"
                  />
                </div>
              </div>
              ...
              <div className="mt-10 md:mt-0 lg:mt-10 xl:mt-20 flex flex-col items-center md:items-start gap-3">
                ...
                <p
                  className="max-w-[665px] max-h-[444px] text-[#210F03] font-Poppins lg:text-[18px] font-light lg:leading-[30px] xl:leading-[37px] text-center md:text-start"
                  data-aos="fade-left"
                >
                  <strong className="text-[#03A651] font-bold">
                    Debt Collection:
                  </strong>{" "}
                  <br />
                  We provide tailored debt collection services, from negotiation
                  to legal action, ensuring effective recovery for financial
                  institutions. <br />
                  <strong className="text-[#03A651] font-bold">
                    Skip Tracing:
                  </strong>{" "}
                  <br />
                  Using advanced methods, we locate hard-to-find debtors,
                  ensuring no debt collection effort is hindered. <br />
                  <strong className="text-[#03A651] font-bold">
                    Asset Tracing:
                  </strong>{" "}
                  <br />
                  We identify and secure debtor assets to facilitate more
                  efficient debt recovery through legal means. <br />
                  <strong className="text-[#03A651] font-bold">
                    Profile Verification:
                  </strong>{" "}
                  <br />
                  Our verification process ensures accurate debtor information
                  for more targeted recovery strategies.
                </p>

                <div
                  ref={sectionRef}
                  className="mt-60 xs:mt-20 sm:mt-2 flex flex-wrap xl:gap-16 gap-10 max-md:p-3 lg:text-lg lg:mt-14 xl:mt-2"
                >
                  <div className="font-Poppins" data-aos="fade-left">
                    <span className="text-[#03A651] font-semibold leading-3 lg:text-2xl xl:text-3xl">
                      {experience}+
                    </span>
                    <br />
