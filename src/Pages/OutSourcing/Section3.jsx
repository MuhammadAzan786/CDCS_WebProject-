                ...
                <ul className="   text-[#210F03] font-Poppins lg:text-[18px]  lg:leading-[30px] xl:leading-[37px] font-light  md:text-start list-disc flex flex-col gap-10  max-md:ml-7 text-sm  sm:text-base  md:leading-[30px] md:gap-[5vw]  lg:gap-[4vw] xl:gap-[170px] md:mt-5  max-w-[647px] max-lg:md:w-[376.5px] max-xl:lg:w-[559.406px]">
                  <li data-aos="fade-left">
                    <span className="font-semibold">
                      Benefits to outsourcing receivables:{" "}
                    </span>
                    <br />
                    <span className="text-sm">
                      Here are some of the benefits to outsourcing accounts
                      receivable:
                    </span>
                    <br />
                    - Allows you to focus on your core business.
                    <br />
                    - Saves capital expenditure for expensive collection
                    software.
                    <br />
                    - Decreases payroll, benefits and other employee overheads.
                    <br />
                    - Ability to draw on a pool of professional a/r personnel
                    ...
                    <br />- Increase customer and employee satisfaction through
                    professional and thorough management of customer accounts.
                  </li>
                  <li data-aos="fade-left">
                    ...
                    <br />- Experience Business & Consumer Credit Reports
                  </li>
                  <li data-aos="fade-left">
                    <span className="font-semibold"> Business Profile </span>
                    <br />
                    Business Profile presents a current, objective picture of
                    how a business handles its financial obligations and
                    comprehensive public record and legal data, conveying not
                    only the company's ability to pay but also its willingness
                    to pay.
                  </li>
                  <li data-aos="fade-left">
                    <span className="font-semibold">
                      Consumer Credit Profile Report{" "}
                    </span>
                    <br />
                    Consumer Credit Profile Report gives you accurate, current
                    and complete information to enhance your decision-making
                    capabilities. Its easy-to-read format, designed with input
                    from our customers, groups similar data elements together
                    for faster analysis.
                  </li>
                  <li className="md:mt-10 xl:mt-0" data-aos="fade-left">
                    <span className="font-semibold">Other Reports - </span>
                    <br />
                    Social Search, Address Updates, Employment Insight, and
                    Collection Reports are examples of a complete line of
                    resources you need to qualify your customers and reduce the
                    risk of bad debts.
                  </li>
