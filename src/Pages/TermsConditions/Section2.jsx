...
const Section3 = () => {
  return (
    ...
    <div  data-aos="fade-left" className="p-2 flex flex-col  md:gap-10 md:items-start items-center lg:gap-22 xl:gap-30">
  ...
  <div className="flex flex-col items-center md:items-start gap-3">
    ...
    WHEREAS, the Client seeks to engage the Service Provider to perform debt collection services for certain accounts of the Client, on a "no-fee" basis;<br/>
WHEREAS, the Service Provider has the necessary experience, resources, and expertise to perform such services;<br/>
...
{/* 1. SCOPE OF SERVICES */}
<div id="section1"  className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      1. SCOPE OF SERVICES
    </h1>
...
<div id="section2"   className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      2. COMPENSATION AND PAYMENT
    </h1>
...
<div id="section3" className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      3. CLIENT RESPONSIBILITIES
    </h1>
    ...
    <p className="text-[#210F03] font-Poppins lg:text-[18px] font-light lg:leading-[30px] xl:leading-[37px] md:text-start">
      The Client agrees not to directly contact debtors regarding any referred account(s) without the prior written consent of the Service Provider, unless otherwise agreed.
         ...
         <div id="section4" className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      4. SERVICE PROVIDER RESPONSIBILITIES
    </h1>
...
<div id="section5" className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      5. TERM AND TERMINATION
    </h1>
...
<div id="section6" className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      6. CONFIDENTIALITY AND DATA PROTECTION
    </h1>
...
<div id="section7" className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start
    ">
      7. INDEMNITY AND LIABILITY
...
<div id="section8" className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start" >
      8. GOVERNING LAW AND DISPUTE RESOLUTION
    </h1>
...
{/* 9. MISCELLANEOUS */}
<div  id="section9"className="p-2 flex flex-col md:flex-row md:gap-20 md:items-start items-center lg:gap-32 xl:gap-40">
  <div className="flex flex-col items-center md:items-start gap-3">
    <h1 className="text-[#03A651] font-poppins text-[20px] font-semibold leading-normal text-center md:text-start">
      9. MISCELLANEOUS
    </h1>
...
{/* ... */}
  ...
  <div className="flex flex-col items-center md:items-start gap-3">
    ...
    <h2 className="font-poppins text-[18px] font-semibold  md:text-start">Client:</h2>
    <p className="text-[#210F03] font-Poppins lg:text-[18px] font-light lg:leading-[30px] xl:leading-[37px] md:text-start">
...
Date: ________________________<br/>
    ...
    <h2  className="font-poppins text-[18px] font-semibold  md:text-start">Service Provider:</h2>
    <p className="text-[#210F03] font-Poppins lg:text-[18px] font-light lg:leading-[30px] xl:leading-[37px] md:text-start">
